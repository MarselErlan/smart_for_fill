...
class ResumeExtractor:
    ...
    def embed_resume(self):
        return self.embed_service.embed_resume()

    def save_resume_embeddings(self, embedding_data: Dict[str, Any], vectorstore: Any = None):
        return self.embed_service.save_resume_embeddings(embedding_data, vectorstore)
